...
2. UPDATE: Short status updates. Keywords: STOP, СТОП, Актуально, Звільнилось місце, Потрібно ще, Набір закрито, +2 места.
3. NOISE: General chat, greetings, Viber system notifications (e.g., "Новий коментар", "приєднався до спільноти", "Дивіться топ-повідомлення"), greetings, questions about candidates, GDPR/RODO.
