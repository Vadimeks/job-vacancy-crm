...
const solanoTemplates = [
  // Вакансія №1 - Куриний мясокомбінат (Розділка пакування курячого філе)
  {
    ...
    agencyName: "SOLANO",
    templateName: "DROBIMEX Karczew Робота на куриному мясокомбінаті, що включає обробку, розділення та пакування курячого філе (М'ясна продукція)",
    vacancydescription:
      "Робота на куриному мясокомбінаті, що включає обробку, розділення та пакування курячого філе (М'ясна продукція) — Karczew",
  ...
  // Вакансія №2 - Куриний мясокомбінат (Розділка пакування курячого філе)
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "SOLANO",
    templateName: "DROBIMEX Lublin Робота на куриному мясокомбінаті, що включає обробку, розділення та пакування курячого філе (М'ясна продукція)",
    vacancydescription:
      "Робота на куриному мясокомбінаті, що включає обробку, розділення та пакування курячого філе (М'ясна продукція) — Lublin",
    category: "Харчова промисловість",
    keywords: [
      "DROBIMEX",
      "Lublin",
  ...
  // Вакансія №3 - Куринне виробництво (Zeewolde, Нідерланди)
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "SOLANO",
    templateName: "STORTEBOOM Zeewolde Робота на підприємстві з виробництва курячої продукції (М'ясна продукція)",
    vacancydescription:
      "Робота на підприємстві з виробництва курячої продукції (М'ясна продукція) — Zeewolde",
    category: "Харчова промисловість",
    keywords: [
      "STORTEBOOM",
      "Zeewolde",
  ...
  // Вакансія №4 - STADLER Siedlce (Виробництво вагонів метро / трамваїв / поїздів)
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "SOLANO",
    templateName: "STADLER Siedlce Робота на сучасному заводі з виробництва вагонів метро, трамваїв та поїздів (Виробництво та промисловість)",
    vacancydescription:
      "Робота на сучасному заводі з виробництва вагонів метро, трамваїв та поїздів (Виробництво та промисловість) — Siedlce",
