...
const kreonTemplates = [
  ...
  {
    agencyName: "KREON",
    templateName: "STADLER Siedlce Виробництво вагонів метро, трамваїв та поїздів: монтажні роботи (механічний, електронний), клеяж, підготовка поверхонь (Виробництво та промисловість)",
    vacancydescription:
      "Виробництво вагонів метро, трамваїв та поїздів: монтажні роботи (механічний, електронний), клеяж, підготовка поверхонь (Виробництво та промисловість) — Siedlce",
