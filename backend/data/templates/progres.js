...
const progresTemplates = [
  // Вакансія №1 - LPP Pruszcz Gdański
  {
    ...
    agencyName: "PROGRES",
    templateName: "LPP Pruszcz Gdański Склад нового одягу: зняття кліпсів, комплектація та пакування інтернет-замовлень (Склади та логістика)",
    vacancydescription:
      "Склад нового одягу: зняття кліпсів, комплектація та пакування інтернет-замовлень (Склади та логістика) — Pruszcz Gdański",
