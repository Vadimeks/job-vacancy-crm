...
const manpawerTemplates = [
  // Вакансія №1 - Hutchinson Bielsko-Biała (Mazańcowice)
  {
    ...
    vacancydescription:
      "Виробництво гумових шлангів для автомобільних систем охолодження та кондиціонування.",
  ...
  // Вакансія №2 - Hutchinson Żywiec 2
  {
    ...
    vacancydescription:
      "Виробництво гумових та пластикових шлангів для автомобільної промисловості.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Hutchinson",
      "Żywiec",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Mondelez Płońsk",
    vacancydescription:
      "Виробництво та фасування печива (Misie Lubisie, Delicje).",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Płońsk",
      "Плоньськ",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Brembo Częstochowa",
    vacancydescription:
      "Виробництво компонентів гальмівних систем для автомобілів.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Częstochowa",
      "Ченстохова",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Lantmannen Stanisławów Pierwszy",
    vacancydescription: "Харчове виробництво: пакування хлібобулочних виробів.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Hutchinson Bielsko-Biała Mazańcowice",
    vacancydescription: "Обслуговування прес-формувальних машин для автопрому.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Bielsko-Biała",
      "Бєльско-Бяла",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Hutchinson Żywiec 1",
    vacancydescription:
      "Виготовлення паливних систем та трубок для автомобільних кондиціонерів (гнуття труб машинним способом).",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Hutchinson",
      "Żywiec",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Mondelez Cieszyn",
    vacancydescription:
      "Легка робота на виробництві вафельних батончиків: фасування та пакування.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Cieszyn",
      "Цешин",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Eurocomfort Leszno",
    vacancydescription:
      "Виробництво матраців, подушок та ковдр для відомого бренду товарів для дому.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Leszno",
      "Лешно",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Mondelez Płońsk B1",
    vacancydescription:
      "Виробництво кондитерської продукції (печиво): збір з лінії та пакування.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Bosch Łódź UDT",
    vacancydescription:
      "Обслуговування навантажувача та логістика на заводі побутової техніки.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Gestamp Wrocław UDT",
    vacancydescription:
      "Оператор навантажувача (UDT) та Milk-run на заводі автомобільних компонентів.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Wrocław",
      "Вроцлав",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "SFC Częstochowa",
    vacancydescription:
      "Виготовлення гумових автозапчастин: обслуговування автоклавів та монтаж.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Częstochowa",
      "Ченстохова",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "BSH Wrocław",
    vacancydescription:
      "Ручна збірка та контроль якості побутової техніки (холодильники, плити).",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
  ...
  // Вакансія №21 - Gestamp Wrocław (Автоматизована лінія)
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MANPAWER",
    templateName: "Gestamp Wrocław",
    vacancydescription:
      "Робота на автоматизованій лінії виробництва автомобільних компонентів: пакування та контроль якості.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Wrocław",
      "Вроцлав",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Gestamp Września",
    vacancydescription:
      "Виробництво автомобільних компонентів: контроль якості або робота на навантажувачі UDT.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Września",
      "Вжесня",
  ...
  // Вакансія №24 - Faurecia Grójec
  {
    ...
    vacancydescription:
      "Виготовлення каркасів та напрямних для автомобільних сидінь: обслуговування машин.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Grójec",
      "Груєць",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Hitachi Łódзь",
    vacancydescription:
      "Оператор машин на виробництві ізоляційних матеріалів для трансформаторів.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Łódź",
      "Лодзь",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Brembo Dąbrowa Górnicza CNC",
    vacancydescription:
      "Візуальний контроль якості та обслуговування CNC машин на заводі гальмівних дисків.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Dąbrowa Górnicza",
      "Даброва Гурнича",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Unirubber Zielonka-Węgliniec",
    vacancydescription:
      "Фізично важка робота на виробництві гумового грануляту (сезонна).",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Węgliniec",
      "Zielonka",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Hutchinson Bielsko-Biała Update",
    vacancydescription:
      "Обслуговування машин для виготовлення автомобільних трубок: монтаж та зварювання.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Bielsko-Biała",
      "Бєльско-Бяла",
  ...
  // Вакансія №31 - Valeo Chrzanów
  {
    ...
    vacancydescription:
      "Виробництво автомобільних ліхтарів та освітлювальних приладів: обслуговування пресів та контроль якості.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Chrzanów",
      "Хжанув",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Lear Legnica",
    vacancydescription:
      "Виробництво металевих конструкцій для автомобільних сидінь: монтаж та обслуговування пресів.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Legnica",
      "Легниця",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "GKN Oleśnica",
    vacancydescription:
      "Виробництво приводних валів та компонентів трансмісії для автомобілів.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Oleśnica",
      "Олешниця",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Chromavis Ciechanów",
    vacancydescription:
      "Виробництво декоративної косметики (лаки для нігтів): пакування та обслуговування лінії.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Ciechanów",
      "Чеханув",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "WND Rąbień",
    vacancydescription:
      "Виробництво сучасних віконних систем: комплектація та збірка конструкцій.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Fiege Mszczonów",
    vacancydescription:
      "Логістичний склад: навантаження та розвантаження товарів за допомогою вилочного навантажувача (UDT).",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Pro Cars Tychy",
    vacancydescription:
      "Робота на пресах: формування металевих деталей для автомобільної промисловості.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
  ...
  {
    agencyName: "MANPAWER",
    templateName: "Gestamp Chocicza Mała Overhead Crane",
    vacancydescription:
      "Обслуговування кран-балки (сувниці) з рівня підлоги на сучасному автомобільному заводі.",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Chocicza Mała",
      "Września",
  ...
  // Вакансія №51 - U Form Bieruń
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MANPAWER",
    templateName: "U Form Bieruń",
    vacancydescription:
      "Робота на пресах та обслуговування машин на заводі автодеталей",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Bieruń",
      "Бєрунь",
  ...
  // Вакансія №52 - Hitachi Łódź
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MANPAWER",
    templateName: "Hitachi Łódź",
    vacancydescription:
      "Оператор машин на виробництві ізоляції для трансформаторів",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Łódź",
      "Лодзь",
  ...
  // Вакансія №53 - Hilding Murowana Goślina Production
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MANPAWER",
    templateName: "Hilding Murowana Goślina",
    vacancydescription: "Виробництво та монтаж матраців (мануальна робота)",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Murowana Goślina",
      "Poznań",
  ...
  // Вакансія №54 - Hilding Murowana Goślina Magazynier
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MANPAWER",
    templateName: "Hilding Murowana Goślina UDT",
    vacancydescription: "Комірник з посвідченням UDT на склад матраців",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
  ...
  // Вакансія №55 - ID LOGISTICS Krajków
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MANPAWER",
    templateName: "ID LOGISTICS Krajków",
    vacancydescription:
      "Складська логістика: формування замовлень та робота з UDT",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
  ...
  // Вакансія №62 - Faurecia Legnica Operator
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MANPAWER",
    templateName: "Faurecia Legnica",
    vacancydescription: "Оператор виробництва автомобільних крісел",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
  ...
  // Вакансія №64 - BCUBE Niepołomice
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MANPAWER",
    templateName: "BCUBE Niepołomice",
    vacancydescription: "Комірник на логістичний склад (з UDT або без)",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Niepołomice",
      "Неполоміце",
  ...
  // Вакансія №65 - Lear Pruszków 4850
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MANPAWER",
    templateName: "Lear Pruszków",
    vacancydescription: "Збирання дрібних деталей інтер’єру авто (сидіння)",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Pruszków",
      "Прушкув",
  ...
  // Вакансія №66 - Lear Pruszków 4700
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MANPAWER",
    templateName: "Lear Pruszków 4700",
    vacancydescription: "Монтажник елементів салону авто (сидіння)",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
  ...
  // Вакансія №69 - Faurecia Legnica 4800 + Housing
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MANPAWER",
    templateName: "Faurecia Legnica Housing",
    vacancydescription: "Оператор виробництва автомобільних крісел (з житлом)",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
  ...
  // Вакансія №71 - Hitachi Energy Łódź Monter
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MANPAWER",
    templateName: "Hitachi Energy Łódź",
    vacancydescription: "Монтаж складових частин промислових трансформаторів",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
      "Łódź",
      "Лодзь",
  ...
  // Вакансія №72 - Hitachi Łódź Operator
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MANPAWER",
    templateName: "Hitachi Łódź Operator",
    vacancydescription:
      "Оператор машин на виробництві ізоляції для трансформаторів",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
    keywords: [
  ...
  // Вакансія №76 - BSH Łódź
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MANPAWER",
    templateName: "BSH Łódź",
    vacancydescription: "Монтаж та збірка пральних і сушильних машин Bosch",
    category: "⚙️ Виробництво і промисловість / Логістика, склади та пакування",
