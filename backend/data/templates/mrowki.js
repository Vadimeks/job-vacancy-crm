...
const mrowkiTemplates = [
  // Вакансія №1 - AMI Mikstat
  {
    ...
    agencyName: "MRÓWKI",
    templateName: "AMI Mikstat Робота з переробки птиці, що включає забій, обробку та миття (М'ясна продукція)",
    vacancydescription:
      "Робота з переробки птиці, що включає забій, обробку та миття (М'ясна продукція) — Mikstat'ясному заводі з переробки птиці, що включає забій, обробку та миття.",
  ...
  // Вакансія №2 - Збірка меблів Sława
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MRÓWKI",
    templateName: "Монтаж меблів Sława Робота монтажником меблів на виробництві та у відрядженнях (Виробництво меблів)",
    vacancydescription:
      "Робота монтажником меблів на виробництві та у відрядженнях (Виробництво меблів) — Sława",
  ...
  // Вакансія №3 - ОПЕРАТОР МАШИН Gostyń
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MRÓWKI",
    templateName: "Поліграфічне підприємство Gostyń Робота оператором офсетних машин з виготовлення упакування (Поліграфія)",
    vacancydescription:
      "Робота оператором офсетних машин з виготовлення упакування (Поліграфія) — Gostyń",
    category: "Виробництво та промисловість",
    keywords: [
      "Gostyń",
      "оператор",
  ...
  // Вакансія №4 - КАЙТЕРИНГ Wysogotowo
  {
    // === 1. СІСТЭМНЫЯ ПАЛІ (Групаванне і пошук) ===
    agencyName: "MRÓWKI",
    templateName: "Кейтеринг Wysogotowo Робота на виробництві готових страв (Кейтеринг)",
    vacancydescription:
      "Робота на виробництві готових страв (Кейтеринг) — Wysogotowo",
    category: "Харчова промисловість",
    keywords: [
      "Wysogotowo",
      "кейтеринг",
